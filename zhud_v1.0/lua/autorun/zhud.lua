...
hook.Add( "HUDPaint", "DrawZHUD", function()
	...
	draw.DrawText( "Vie : "..ply:Health().."%" ,"Trebuchet24", 200, ScrH()-121, Color( 0, 0, 0, 255 ), TEXT_ALIGN_CENTER )
	...
	draw.DrawText( "Armure : "..ply:Armor().."%" ,"Trebuchet24", 200, ScrH()-88, Color( 0, 0, 0, 255 ), TEXT_ALIGN_CENTER )
	
	-- Compteur Kills + Morts
	
	draw.DrawText( "Kills : "..ply:Frags() ,"Trebuchet24", 25, ScrH()-50, Color( 255, 255, 255, 255 ), TEXT_ALIGN_LEFT )
	
	draw.DrawText( "Morts : "..ply:Deaths() ,"Trebuchet24", 380, ScrH()-50, Color( 255, 255, 255, 255 ), TEXT_ALIGN_RIGHT )
	...
	draw.DrawText( "Ratio K/M : "..kdr ,"Trebuchet16", 200, ScrH()-45, Color( 255, 255, 255, 255 ), TEXT_ALIGN_CENTER )
	...
	if(!ply:Alive()) then
        ...
        draw.DrawText("Vous êtes mort", "Trebuchet42", ScrW()/2, 100, Color(255, 0, 0, 255), TEXT_ALIGN_CENTER)
    end
end)
